...
class MainActivity : AppCompatActivity() {
    ...
    fun btnClick2(view: View){
        ...
        val linerLayout1 = findViewById<LinearLayout>(R.id.linearLayout1)
        val linerLayout2 = findViewById<LinearLayout>(R.id.linearLayout2)
        val linerLayout3 = findViewById<LinearLayout>(R.id.linearLayout3)
